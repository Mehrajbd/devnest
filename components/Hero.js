      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        <div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-10 lg:w-1/2">
            ...
            {/* Animated Badge */}
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 shadow-lg w-fit group hover:shadow-xl transition-all duration-500 hover:scale-105">
              <div className="relative">
                <div className="w-3 h-3 bg-gradient-to-r from-green-400 to-cyan-400 rounded-full animate-ping absolute"></div>
                <div className="w-3 h-3 bg-gradient-to-r from-green-400 to-cyan-400 rounded-full relative"></div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <h2 className="text-xl md:text-2xl font-light leading-relaxed text-gray-600 dark:text-gray-300 pl-6 border-l-2 border-gray-200 dark:border-gray-700">
                  Transforming visionary ideas into <span className="font-semibold text-gray-700 dark:text-gray-200">scalable digital experiences</span> that drive innovation and business growth through cutting-edge technology.
                </h2>
              </div>
            </div>
                ...
                <div className="relative w-full h-full transform-style-3d transition-transform duration-700 group-hover:rotate-y-10">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-600/10 rounded-3xl shadow-2xl border border-white/20 backdrop-blur-xl transform rotate-3 transition-transform duration-500 group-hover:rotate-0">
                    <div className="absolute inset-4 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl flex items-center justify-center overflow-hidden">
                      ...
                      {/* Central Icon with Company Logo */}
                        ...
                        <div className="relative w-32 h-32 mb-6 mx-auto group/logo">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-3xl p-1 animate-gradient">
                            <div className="w-full h-full bg-gray-900 rounded-2xl flex items-center justify-center">
                              {/* Company Logo */}
                              <div className="relative w-20 h-20 transform group-hover/logo:scale-110 transition-transform duration-500">
                                <Image
                  ...
                  <div className="absolute -top-6 -right-6 w-20 h-20 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl rotate-12 animate-float shadow-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <span className="text-2xl">⚡</span>
                  </div>
                  
                  <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-r from-purple-400 to-pink-500 rounded-2xl -rotate-12 animate-float delay-2000 shadow-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <span className="text-2xl">🎯</span>
                  </div>

                  <div className="absolute top-1/2 -right-12 w-16 h-16 bg-gradient-to-r from-green-400 to-cyan-500 rounded-2xl rotate-45 animate-float delay-4000 shadow-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
