  ...
  return (
    <footer className="w-full border-t border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="container mx-auto max-w-7xl px-4">
        {/* Main Footer Content */}
        <div className="py-12 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
          {/* Company Info */}
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md text-sm leading-relaxed">
              Transforming ideas into powerful digital solutions. We specialize in creating innovative, 
              scalable, and high-performance applications that drive business growth.
            </p>
            
            {/* Address */}
            <div className="space-y-3">
              <h4 className="font-semibold text-gray-900 dark:text-white text-sm">Our Office</h4>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4 text-sm">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4 text-sm">Services</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/services" className="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors">
                  Web Development
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4 text-sm">Get In Touch</h3>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                ...
                <a href="mailto:hello@softrevoX.com" className="hover:text-blue-600 transition-colors">
                  hello@softrevoX.com
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                ...
                <a href="https://facebook.com/softrevoX" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
                  /softrevoX
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                ...
                <a href="https://github.com/softrevoX" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
                  /softrevoX
                </a>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="text-gray-600 transition-all duration-300 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 hover:scale-110"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 transition-all duration-300 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:scale-110"
                aria-label="GitHub"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.165 6.839 9.491.5.092.682-.217.682-.482 0-.237-.009-.868-.014-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.031-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.203 2.398.1 2.651.64.7 1.03 1.595 1.03 2.688 0 3.848-2.338 4.695-4.566 4.942.359.308.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.001 10.001 0 0022 12c0-5.523-4.477-10-10-10z" fillRule="evenodd" />
              ...
              <a 
                href="https://twitter.com/softrevoX" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 transition-all duration-300 hover:text-blue-400 dark:text-gray-400 dark:hover:text-blue-400 hover:scale-110"
                aria-label="Twitter"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
